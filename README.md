...
`~/.hanspell-typos` 파일에 아래와 같이 사용자가 직접 맞춤법을 정의해서 표기법을 통일하고 더 나은 표현을 제시하는데 활용할 수 있습니다.
...
첫 번째 표현식은 “돈키호테” 좌우에 Lookahead and Lookbehind가 없어서 “돈키호테는”, “돈키호테여!” 등에 모두 적용됩니다.
