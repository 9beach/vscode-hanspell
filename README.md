...
첫째, 맞춤법 검사 웹 서비스가 간과하는 것을 직접 정의할 수 있습니다.

둘째, 문서 작성 과정에서 사용자 정의 맞춤법 오류를 만나면 자동으로 분석됩니다. 맞춤법 검사 뒤 같은 실수를 반복하면 자동으로 밑줄이 표시됩니다. 새로 검사하기 전에도 최근 결과로 계속 분석하기 때문입니다. 사용자 정의 맞춤법은 최근 검사에서 발견된 오류처럼 작동합니다. 따라서 한 번 검사를 실행한 뒤에는 발견 여부와 무관하게 자동으로 분석됩니다.
