...
```json
{
  "bad-expressions": [
    ...
    },
    {
      ...
      "expression": "[가-힣]+(기 때문|[을를] (가[지진져집졌질]|갖는|지[니닌닙녀녔닐])|게 [된됩될돼되됐]|고 있|[혀해여려겨] [주준줬줘줍줄]|져 있|시[키켰킬켜킨])[가-힣]*",
      "info": "군더더기 있는 표현입니다.",
...
두 번째 표현식은 “우리의 사랑의”처럼 ‘-의’를 겹쳐 쓴 표현을 “우리 사랑의”로 고치도록 제안합니다.

세 번째 표현식은 “알려 줍니다”, “울게 되었다” 등 군더더기 있는 표현에 밑줄을 긋도록 설정합니다.

[“사용자 정의 표현식” 예시](https://gist.github.com/9beach/3e11ceafcf9477b0bf9f6512f8a4b55a)에 유용한 사례가 계속 추가됩니다. 참고하시고 제안 댓글도 환영합니다.
